...
* Red Hat Enterprise Linuxバージョン7.xおよび8.0から8.7。x86_64アーキテクチャに基づいています。
...
* MySQL Community Editionバージョン8.0.32（MySQLリポジトリから入手）。
* OpenJDKバージョン11.0.18（Red Hat Extra Enterprise Linux Serverリポジトリから入手）
* Python 3.6.x
