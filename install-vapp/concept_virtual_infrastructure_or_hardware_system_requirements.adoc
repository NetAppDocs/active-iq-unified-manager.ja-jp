...
さらに、Unified Managerの2つ目のインスタンスをインストールする前に、1つのUnified Managerインスタンスが監視できるノード数には制限があります。ノード制限、CPU、メモリの推奨事項については、link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["Unified Managerベストプラクティスガイド"^]を参照してください。
