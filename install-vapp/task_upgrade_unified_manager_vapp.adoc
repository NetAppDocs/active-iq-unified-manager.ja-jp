...
[role="lead"]
Active IQ Unified Managerリリース9.14または9.16からリリース9.18へのアップグレードのみ可能です。
...
[NOTE]
====
お使いのシステムがUnified Manager 9.7からアップグレードされている場合、Debianバージョンのファイルシステムの変更により、9.14から9.18へ直接アップグレードすることはできません。代わりに、推奨されるアップグレードパスに従ってください：9.14 -> 9.16P2 -> 9.18。
