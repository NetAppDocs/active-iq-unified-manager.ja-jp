...
* Microsoft Visual C++ Redistributable Packages for Visual Studio 2015 version 14.29.30133.0
* MySQL Community Editionバージョン8.4.10
* Python 3.13.3
* OpenJDK バージョン 17.0.15+6
* 7-zip バージョン 25.01 以降
