...
NetApp Active IQは、NetAppハイブリッドクラウド全体のストレージシステム運用を最適化するために、予測分析とプロアクティブなサポートを提供するクラウドベースのサービスです。詳細については、 https://docs.netapp.com/us-en/active-iq/index.html["NetApp Active IQ の略"^]を参照してください。
