...
[NOTE]
====
「`WFA pack for managing Clustered Data ONTAP`」は WFA 5.1.1P6 に含まれているため、以前のように NetAppStorage Automation Store からこのパックをダウンロードして WFA サーバーに個別にインストールする必要はありません。 https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["WFAダウンロード"^]
